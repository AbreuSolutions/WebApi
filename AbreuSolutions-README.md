 # ASP.NET Core WebApi_Test

## Technologies
- ASP.NET Core 3.1 WebApi_Test
- REST Standards
...
- [x] WebApi_Test.Controllers ==>> HomeController
- [x] WebApi_Test.Controllers.api ==>> ApiProdutoController
- [x] WebApi_Test.Controllers.api ==>> ApiUsuarioController
